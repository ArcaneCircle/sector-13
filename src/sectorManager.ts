...
function managePlayerHit(enemy: Sprite) {
  if (state.playershield > 0) {
    ...
    explosionManager.add(
      getExplosion(data.sprites.player.x, data.sprites.player.y),
    );
    if (!!enemy.type) {
      enemy.hit();
    } else {
    ...
    if (state.lives === 0) {
      ...
      state.invulnerableAt =
        state.lives === 0 ? state.totalTime + 5000 : state.totalTime;
      state.invulnerable = true;
      adjustFear(50);

      setTimeout(() => {
        if (!state.gameOver) {
          data.sprites.player.opacity = 0.75;
        }
      }, 250);
    }
...
export class Sector {
  ...
  constructor(
    sector: Array<SectorData>,
    sectorComms: Array<string>,
  ...
  render() {
    if (this.completed) {
      ...
      data.scenes.game.objects[3] = getNumbers(
        state.currentSectorNumber.toString(),
        state.currentSectorNumber < 10 ? 74 : 70,
        12,
        { scale: 20 },
      );
      ...
      if ((data.scenes.game.objects[2] as Sprite).y < 2 * SCALE) {
        ...
        if (this.powerupProbability && !state.hardcore) {
          ...
          powerupManager.add(
            getPowerup(
              commsSprite.width / 2,
              commsSprite.y + commsSprite.height + 80,
              this.powerupProbability,
            )!,
          );
        }
      ...
      if (!this.hasFirstSpawn) {
        state.sectorTime = 0;
        this.hasFirstSpawn = true;
      }
      for (const [
        spawnStart,
        totalSpawn,
        ...
        if (
          state.sectorTime >= spawnStart &&
          manager.spawned < totalSpawn &&
          (state.sectorTime + spawnStart) % spawnSpacing === 0
        ) {
        ...
        if (!state.invulnerable) {
          ...
          manager.assets.forEach((enemy) => {
            if (
              collides(data.sprites.player, enemy.shield ? enemy.shield : enemy)
            ) {
 ...
 */
const cosFn =
  (shipXSpeed: number, waveXSpread: number, xPosition: number, dy: number) =>
  (enemy: Enemy) => {
...
const neutral =
  (startX: number, dy: number, rotation: 180 | 0 = 0) =>
  (enemy: Enemy) => {
    if (!enemy.initialized) {
...
const zigZag =
  ...
  (enemy: Enemy) => {
    ...
    if (
      enemy.x + enemy.width * SCALE > WIDTH ||
      enemy.x - enemy.width * SCALE < 0
    ) {
      enemy.dx *= -1;
    }
  };
const across =
  (startX: number, startY: number, dx: number) => (enemy: Enemy) => {
    if (!enemy.initialized) {
      enemy.x = startX;
      enemy.y = startY;
      enemy.dx = dx;
...
function getAllSectors() {
  const sector1 = new Sector(
    [
      [
        ...
        40,
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(80, 200, 1200, 4)),
      ],
      [
        0,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(80, -200, 300, 4)),
      ],
    ],
    [
  ...
  const sector2 = new Sector(
    [
      [
        ...
        40,
        getEnemyShip,
        Enemies.enemyBlueTwo,
        new Manager(zigZag(1300, 0, -12, 8)),
      ],
      [
        0,
        spawns,
  ...
  const sector3 = new Sector(
    [
      [
        ...
        40,
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(0, 500, 4)),
      ],
      [
        0,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(WIDTH, 600, -4)),
      ],
      [
        0,
        spawns,
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(WIDTH, 900, -4)),
      ],
    ],
    [],
  );
  ...
  const sector5 = new Sector(
    [
      [
        ...
        40,
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(150, 256, -4, -4, 0)),
      ],
      [
        0,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(0, 256, 4, -4, 90)),
      ],
      [
        0,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(0, 30, 4, 4, 180)),
      ],
      [
        0,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(150, 30, -4, 4, 270)),
      ],
    ],
    [
  ...
  const sector7 = new Sector(
    [
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(200, 200, 450, 8)),
      ],
      [
        0,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(200, -200, 1050, 8)),
      ],
    ],
    [],
  );
  const sector8 = new Sector(
    [
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(150, 256, -4, -4, 0, spawns * 40)),
      ],
      [
        120,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(0, 256, 4, -4, 90, spawns * 40)),
      ],
      [
        120,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(0, 30, 4, 4, 180, spawns * 40)),
      ],
      [
        120,
        1,
        ...
        getEnemyShip,
        Enemies.enemyYellowOne,
        new Manager(yellowOne(150, 30, -4, 4, 270, spawns * 40)),
      ],
  ...
  const sector10 = new Sector(
    [
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(80, 400, 1000, 2)),
      ],
      [
        0,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(80, -400, 500, 2)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyGreen,
        new Manager(across(WIDTH, 1200, -4)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(WIDTH, 800, -4)),
      ],
      [
        80,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(WIDTH, 1000, -4)),
      ],
    ],
    [],
  );
  ...
  new Array(5).fill("").forEach((_, i: number) => {
    s11YellowOneSpawns.push([
      380 * i,
      1,
      40,
      getEnemyShip,
      Enemies.enemyYellowOne,
      new Manager(yellowOne(150, 256, -4, -4, 0, 360)),
    ]);
    s11YellowOneSpawns.push([
      380 * i,
      1,
      ...
      getEnemyShip,
      Enemies.enemyYellowOne,
      new Manager(yellowOne(0, 256, 4, -4, 90, 360)),
    ]);
    s11YellowOneSpawns.push([
      380 * i,
      1,
      ...
      getEnemyShip,
      Enemies.enemyYellowOne,
      new Manager(yellowOne(0, 30, 4, 4, 180, 360)),
    ]);
    s11YellowOneSpawns.push([
      380 * i,
      1,
      ...
      getEnemyShip,
      Enemies.enemyYellowOne,
      new Manager(yellowOne(150, 30, -4, 4, 270, 360)),
    ]);
  });
  ...
  const sector11 = new Sector(
    [
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueTwo,
        new Manager(neutral(1300, -8, 180)),
      ],
    ],
    ["commander look out", " ", "behind you"],
    data.powerupprobability.wingbomb[0],
  );

  const s12YellowOneSpawns: Array<SectorData> = [];
  new Array(5).fill("").forEach((_, i: number) => {
    s12YellowOneSpawns.push([
      400 + spawns * 40 * i,
      spawns,
      40,
      getEnemyShip,
      Enemies.enemyYellowTwo,
      new Manager(across(0, 500, 8)),
    ]);
    s12YellowOneSpawns.push([
      450 + spawns * 40 * i,
      spawns,
    ...
    s12YellowOneSpawns.push([
      ...
      getEnemyShip,
      Enemies.enemyYellowTwo,
      new Manager(across(WIDTH, 600, -8)),
    ]);
    s12YellowOneSpawns.push([
      450 + spawns * 40 * i,
      spawns,
      ...
      getEnemyShip,
      Enemies.enemyYellowTwo,
      new Manager(across(WIDTH, 800, -8)),
    ]);
  });
  ...
  const sector12 = new Sector(
    [
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(120, 300, 1000, 10)),
      ],
      [
        0,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(cosFn(120, -300, 500, 10)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueTwo,
        new Manager(cosFn(80, 50, 1200, 5)),
      ],
      [
        0,
        spawns,
  ...
  const sector13 = new Sector(
    [
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(across(WIDTH, 700, -8)),
      ],
      [
        240,
        spawns * 2,
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyPink,
        new Manager(zigZag(1300, 0, -3, 10)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(0, HEIGHT - 300, 6)),
      ],
      [
        1740,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyYellowTwo,
        new Manager(across(WIDTH, HEIGHT - 200, -6)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyPink,
        new Manager(zigZag(1300, 0, -3, 20)),
      ],
      ...
      [
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(zigZag(200, 0, 12, 12)),
      ],
      [
        2320,
        spawns,
        ...
        getEnemyShip,
        Enemies.enemyBlueOne,
        new Manager(zigZag(1300, 0, -12, 12)),
      ],
      [
        2320,
        spawns,
...
function endGame() {
  state.gameOver = true;
  window.highscores.setScore(state.score);
  setTimeout(() => {
